...
{
    public class SingleSessionViewModel : IValidatableObject
    {
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            if (SessionDate.HasValue)
            {
                ...
                {
                    yield return new ValidationResult("SessionDate is invalid.", new[] { "SessionDate" });
                }

                if (SessionDate.Value.Date < DateTime.Now.Date)
                    yield return new ValidationResult("SessionDate must be today or later.", new[] { "SessionDate" });
            }
