...
namespace eLearnApps
{
    public class Constants
    {
        ...
        public int MaxICSSessionLength = 4 * 60 * 60; // 4h - unit is in seconds
        public int MinICSSessionLength = 15 * 60; // 15m - unit is in seconds
        public string KendoDisplayTimeSpanFormat = @"HH:mm";
        public string DisplayTimeSpanFormat = @"HH\:mm";
        public string DisplayDateFormat = "dd MMM yyyy";
        public string DisplayDateTimeFormat = "dd MMM yyyy hh:mm tt";
        public string ShortDateTimeFormat = "yyyy/MM/dd";
        public string DateTimeHourFormat = "yyyy/MM/dd HH:mm";
        public string DefaultScheduleStartTime = "yyyy/MM/dd 08:00";
        public string DefaultScheduleEndTime = "yyyy/MM/dd 22:30";
        public string ApplicationJson = "application/json";
        public string ColorOwner = "#f8a398";
        public string ColorTeamMate = "#51a0ed";
        public int PageSize = 10;
        public string SingaporeStandardTime = "Singapore Standard Time";
        public string Gmt8 = "GMT+08:00";
        public string DefaultOffSet = "+08:00";
        public int RemainingHour = 0;
        public string SplitKey = "___";
        public string HomePageUrl = "https://www.smu.edu.sg/";
        public string DateTimeFormatUniversal = "yyyyMMddTHHmmssZ";
        public string SmuDomain = "smu.edu.sg";
        public string AttachmentFileName = "Attachment";
